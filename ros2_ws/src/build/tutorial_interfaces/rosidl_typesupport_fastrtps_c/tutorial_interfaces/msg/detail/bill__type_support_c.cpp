...
#include "tutorial_interfaces/msg/detail/bill__rosidl_typesupport_fastrtps_c.h"
...
using _Bill__ros_msg_type = tutorial_interfaces__msg__Bill;
...
size_t get_serialized_size_tutorial_interfaces__msg__Bill(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Bill__ros_msg_type * ros_message = static_cast<const _Bill__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Bill__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tutorial_interfaces__msg__Bill(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tutorial_interfaces
size_t max_serialized_size_tutorial_interfaces__msg__Bill(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tutorial_interfaces__msg__Bill;
    is_plain =
      (
...
static size_t _Bill__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tutorial_interfaces__msg__Bill(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tutorial_interfaces, msg, Bill)() {
