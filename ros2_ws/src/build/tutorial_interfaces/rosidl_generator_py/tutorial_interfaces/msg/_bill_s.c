...
bool tutorial_interfaces__msg__bill__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tutorial_interfaces.msg._bill.Bill", full_classname_dest, 34) == 0);
  }
  tutorial_interfaces__msg__Bill * ros_message = _ros_message;
  {  // bill_number
...
PyObject * tutorial_interfaces__msg__bill__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tutorial_interfaces.msg._bill");
