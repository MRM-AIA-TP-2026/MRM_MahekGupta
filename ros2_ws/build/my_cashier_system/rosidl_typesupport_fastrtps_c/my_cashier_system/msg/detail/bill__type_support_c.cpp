...
#include "my_cashier_system/msg/detail/bill__rosidl_typesupport_fastrtps_c.h"
...
#include "my_cashier_system/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Bill__ros_msg_type = my_cashier_system__msg__Bill;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_cashier_system
size_t get_serialized_size_my_cashier_system__msg__Bill(
  const void * untyped_ros_message,
...
static uint32_t _Bill__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_cashier_system__msg__Bill(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_cashier_system
size_t max_serialized_size_my_cashier_system__msg__Bill(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_cashier_system__msg__Bill;
    is_plain =
      (
...
static size_t _Bill__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_cashier_system__msg__Bill(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_cashier_system, msg, Bill)() {
